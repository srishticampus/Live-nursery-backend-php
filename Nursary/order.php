...
<style type="text/css">
    ...
    <section class="blog-content-area section-padding-0-100">
        ...
        <tbody>
            <?php
            $i=1;
            $sql="SELECT product.name, product.file, cart.quantity,product.price,billing.order_status,billing.id as bid FROM `billing` inner JOIN cart on billing.cart_id=cart.id INNER JOIN product on cart.product_id = product.id WHERE product.owner_id=$id order by billing.id desc";
