                            ...
                            <div class="widget-desc">
                                ...
                                if($count>0){
                                   ...
                                   <!--  <input type="checkbox" class="custom-control-input" id="customCheck1"> -->
                                    <label class="custom-control-label" for="customCheck1"><?php echo $row['name'];?> <span class="text-muted">(<?php echo $row['quantity'];?>)</span></label>
                                </div>
                                        <?php
...
<?php
$sql="select distinct product.id,product.file,product.name,review.count,product.price from review inner join product on review.product_id=product.id where review.count=5 limit 3";
$result=$con->query($sql);
$count=$result->num_rows;
if($count>0){
    while($row=$result->fetch_assoc()){
        ...
        ?>
         <div class="single-best-seller-product d-flex align-items-center">
                                    <div class="product-thumbnail">
                                        <a href="shop-details.php?id=<?php echo $row['id'];?>"><img src="uploads/<?php echo $row['file'];?>" alt=""></a>
                                    </div>
                                    <div class="product-info">
                                        <a href="shop-details.php?id=<?php echo $row['id'];?>"><?php echo $row['name'];?></a>
...
?>
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="shop-products-area">
                        ...
                        <?php
                        if(!isset($id)){
                        $sql1="select * from product where owner_id=$id";
                    }
                    else{
                        ...
                        if($count1>0){
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                ...
                                <a href="#">Item Not Available</a>
                            </div>
                                            <?php
                                        }
                                        ?>
                                
                                        <a href="shop-details.php?id=<?php echo $row1['id'];?>"><img src="<?php echo 'uploads/'.$row1['file'];?>" alt=""></a>
                                    ...
                                    <div class="product-info mt-15 text-center">
                                        <a href="shop-details.php?id=<?php echo $row1['id'];?>">
